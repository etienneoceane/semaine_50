...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 01 fév. 2021 à 10:02
...
CREATE TABLE IF NOT EXISTS `annonces` (
  ...
  `an_offre` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Type d''offre. Lettres A, L ou V.',
  `an_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Type de bien',
  `an_pieces` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '1' COMMENT 'Nombre de pièces (facultatif)',
